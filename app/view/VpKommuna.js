 ...
 * Date: Mon May 18 2020 19:24:17 GMT+0300 (EEST)
 *
...
Ext.define('Osmd.view.VpKommuna', {
    extend: 'Ext.container.Viewport',
    alias: 'widget.vpkommuna',

    requires: [
        'Osmd.view.VpKommunaViewModel',
        'Osmd.view.menu.TabPnCenter',
        'Osmd.view.menu.TabPnLeft',
        'Ext.tab.Panel'
    ],
