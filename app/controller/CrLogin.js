 ...
 * Date: Sun Feb 18 2018 23:37:13 GMT+0200 (EET)
 *
...
Ext.define('Osmd.controller.CrLogin', {
    ...
    onBtninputClick: function(button, e, eOpts) {
        ...
        */
                ...
                stUser.add({'house_id':"0",'login':results.login,
                ...
                StHouses.load({
                    ...
                    callback: function(records,operation,success){
                        if(success){
                            var house_id = records[0].data.house_id;
                            var v =stUser.getAt(0);
                            v.set({'house_id':house_id});
                            stUser.sync();
